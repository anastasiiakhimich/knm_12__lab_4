...
left_comp_ip = "localhost"
middle_comp_ip = "localhost"
right_comp_ip = "localhost"
...
LEFT_PAD = c.create_line(LEFT_PAD_W / 2, 0, LEFT_PAD_W / 2, LEFT_PAD_H, width=LEFT_PAD_W, fill="blue")
